...
function _form2(){
    ...
    fsizeW="160px";
   return `
    <div class="" style="min-height:600px; margin: auto;padding: 20px;float: right;">`
        // +_formNoHeader({
        //     shadow:false,
        ...
        //     })
        // +`</h2>
        // background-image:url('`+assert+`/fs_css/teknologi5.gif');border-radius: 20%;
        ...
        +`<div class=""  style="padding:50px;padding-top:0px;">`
            +_sejajar({
                attrCol:"style='padding-left: 15%;'",
                data:[{
                    isi:`
                        <a class="navbar-brand justify-content-center" href="#" onclick="_login(5)" rel="tooltip" data-placement="bottom" >
                            <img src="`+assert+`fs_css/logo/1.png" style="width:120px">
                        </a>
                    `
                }]
            })
